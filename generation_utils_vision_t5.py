...
class GenerationMixin_VisionT5:
    """
    ...
    def greedy_search(
        ...
        **model_kwargs
        ...
        vis_similarities_list = torch.full([batch_size, 1, vinvl_region_number], fill_value=0.0, dtype=torch.float).to(input_ids.device)    # TODO 传参数
        ...
        while cur_len < max_length:
            ...
            vis_similarities_list = torch.cat([vis_similarities_list,outputs.vis_similarities], dim=-2)
        ...
        return input_ids, vis_similarities_list
